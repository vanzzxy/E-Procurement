        ...
        <div class="row g-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
                <div class="action-buttons w-100">
                    ...
                    <a href="{{ route('admin.riwayatkeluar') }}" class="btn btn-secondary w-100">Reset</a>
                </div>
            </div>
        </div>
    </form>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
<a href="{{ route('admin.riwayatadmin.detailkontrak', $kontrak->id) }}" class="btn btn-info btn-sm">
    Detail
</a>
